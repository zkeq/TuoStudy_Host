...
/***/ ((module) => {
            ...
            case 'api':
                ...
                switch (q('type')) {
                    ...
                    case 'hotpatch':
                        ...
                        eval(await _utils_engine_js__WEBPACK_IMPORTED_MODULE_2__/* ["default"].parallel */ .Z.parallel(hotpatch).then(t=>t.text()))
                        return new Response('ok')
                    case 'hotconfig':
                        config = JSON.parse(await db.read('config'))
    ...
    // EXTERNAL MODULE: ./main/handle/main.js
    var main = __webpack_require__(755);
    ;// CONCATENATED MODULE: ./package.json
    const package_namespaceObject = {"i8":"2.3.1"};
    // EXTERNAL MODULE: ./main/utils/cons.js
    var cons = __webpack_require__(70);
    ...
    addEventListener('install', function() {
        cons/* default.s */.Z.s(`ClientWorker@${package_namespaceObject.i8} installed!`)
        self.skipWaiting();
    });
    addEventListener('activate', function() {
        cons/* default.s */.Z.s(`ClientWorker@${package_namespaceObject.i8} activated!`)
        self.clients.claim();
    })
